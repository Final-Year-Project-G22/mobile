...
Either<AuthValueFailure<String>, String> validateEmail(String input) {
  if (input.isEmpty) {
    return left(AuthValueFailure.emptyField(failedValue: input, fieldName: 'Email'));
  }
...
Either<AuthValueFailure<String>, String> validatePassword(String input) {
  if (input.isEmpty) {
    return left(AuthValueFailure.emptyField(failedValue: input, fieldName: 'Password'));
  }
...
Either<AuthValueFailure<String>, String> validateFirstName(String input) {
  if (input.isEmpty) {
    return left(AuthValueFailure.emptyField(failedValue: input, fieldName: 'First Name'));
  }
...
Either<AuthValueFailure<String>, String> validateLastName(String input) {
  if (input.isEmpty) {
    return left(AuthValueFailure.emptyField(failedValue: input, fieldName: 'Last Name'));
  }
