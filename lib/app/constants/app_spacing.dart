...
class AppSpacing {
  ...
  static const double radiusSm = 8; // Small chips
  static const double radiusMd = 12; // Medium — inputs, standard cards, buttons
  static const double radiusLg = 16; // Large — FABs, larger cards
  static const double radiusLgIncreased = 20; // Hero cards
  static const double radiusXl = 28; // ExtraLarge — dialogs, bottom sheets
  static const double radiusXlIncreased = 32;
