...
class _UsersClient implements UsersClient {
  ...
  Future<HttpResponse<UploadAvatarResponse>> uploadAvatar({
    ...
    final _options = _setStreamType<HttpResponse<UploadAvatarResponse>>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
  ...
  Future<HttpResponse<UpdateUserProfileResponseBody>> updateUserProfile({
    ...
    final _options =
        _setStreamType<HttpResponse<UpdateUserProfileResponseBody>>(
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late UpdateUserProfileResponseBody _value;
    try {
      _value = UpdateUserProfileResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
