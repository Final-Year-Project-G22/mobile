...
_OAuthCallbackResponse _$OAuthCallbackResponseFromJson(
  ...
  emailRequired: json['emailRequired'] == null
      ? null
      : OAuthEmailRequiredResponse.fromJson(
          json['emailRequired'] as Map<String, dynamic>,
        ),
...
Map<String, dynamic> _$OAuthCallbackResponseToJson(
  _OAuthCallbackResponse instance,
) => <String, dynamic>{
