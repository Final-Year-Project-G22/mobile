...
_GetCurrentUserResponseBody _$GetCurrentUserResponseBodyFromJson(
...
Map<String, dynamic> _$GetCurrentUserResponseBodyToJson(
  _GetCurrentUserResponseBody instance,
) => <String, dynamic>{
