...
part 'set_category_translations_request.freezed.dart';
...
abstract class SetCategoryTranslationsRequest with _$SetCategoryTranslationsRequest {
  ...
  }) = _SetCategoryTranslationsRequest;

  factory SetCategoryTranslationsRequest.fromJson(Map<String, Object?> json) =>
      _$SetCategoryTranslationsRequestFromJson(json);
}
