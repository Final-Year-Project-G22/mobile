...
@Freezed()
abstract class DeleteCampaignTemplateTranslationResponseBody
    with _$DeleteCampaignTemplateTranslationResponseBody {
  ...
  factory DeleteCampaignTemplateTranslationResponseBody.fromJson(
